...
During the creation of this framework, mainly five approaches have been analyzed to derive the aforementioned processing steps:
+ [*Model Agnostic Globally Interpretable Explanations (MAGIX)*](https://arxiv.org/abs/1706.07160): It was the primary intent of the thesis and the created software package to create and enhance the concepts of MAGIX. Several steps of the method, described in the paper were generalized, adapted, and the given template was extended. The name "MAGIE" was chosen for the framework to acknowledge the major impact MAGIX had on the overall software package.
